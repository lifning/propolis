...
// Add non-legacy ID base and VIRTIO_ID_INPUT (18) to get 0x1052
pub const VIRTIO_DEV_INPUT: u16 = 0x1040 + VIRTIO_SUB_DEV_INPUT;
...
pub const VIRTIO_SUB_DEV_INPUT: u16 = 0x12;
